...
#    Updated: 2019/04/18 12:44:26 by abarthel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):
	@$(MAKE) -j -C ./libft objects
	@printf "\n"
	@$(MAKE) -j -C ./libftwchar objects
	@printf "\n"
	@$(MAKE) -j -C ./libftprintf objects
...
clean:
	...
	@$(MAKE) -j -C ./libftwchar clean
	@$(MAKE) -j -C ./libftprintf clean
