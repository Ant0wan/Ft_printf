...
/*   Updated: 2019/03/12 17:54:56 by abarthel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
	...
	ret1 = printf("normal test%+d %d %d %d", 1548, INT_MAX + 1, 42, 0);
	printf("\t%d\n", ret1);
	ret2 = ft_printf("normal test%+d %d %d %d", 1548, INT_MAX + 1, 42, 0);
	printf("\t%d\n", ret2);
	printf("\n\n");
...
//	printf("\n\n");
//
//	ret1 = printf("Dollars test %4$40d %3$hhd %1$d %2$+d", INT_MAX + 2, INT_MAX + 1, (signed char)(4200 * -1), -15);
//	printf("\t%d\n", ret1);
//	ret2 = ft_printf("Dollars test %4$40d %3$hhd %1$d %2$d", INT_MAX + 2, INT_MAX + 1, (signed char)(4200 * -1), -15);
//	printf("\t%d\n", ret2);	
//	printf("\n\n");
//
	printf("\n*******************************************************\n");
