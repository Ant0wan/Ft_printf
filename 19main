...
/*   Updated: 2019/04/10 19:27:14 by abarthel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	ft_printf("%y");
	ret1 = printf("%1.5ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%1.5ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%5.5ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%5.5ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%1.3ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%1.3ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%1.4ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%1.4ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%5.6ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%5.6ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%7.6ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%7.6ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%ls", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%ls", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	ret1 = printf("%10.10ls!", L"电脑是新的");
	printf("%d\n", ret1);
	ret2 = ft_printf("%10.10ls!", L"电脑是新的");
	printf("%d\n", ret2);
	printf("\n\n");
	...
	ret1 = printf("%100ls", L"😢 ");
	printf("%d\n", ret1);
	ret2 = ft_printf("%100ls", L"😢 ");
	printf("%d\n", ret2);
	printf("\n\n");

	ret1 = printf("%100ls", L"   ƑƤ♢😲😊pÄ😼😷ȗ°Æ😥ħ☇¥ȂN😄5😚😅Ň¦♖😖");
	printf("%d\n", ret1);
	ret2 = ft_printf("%100ls", L"   ƑƤ♢😲😊pÄ😼😷ȗ°Æ😥ħ☇¥ȂN😄5😚😅Ň¦♖😖");
	printf("%d\n", ret2);
	printf("\n\n");
