...
/*   Updated: 2019/02/06 11:57:29 by abarthel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_atoi(const char *str) __attribute__
				((nonnull(1)));
...
size_t			ft_strlen(const char *s) __attribute__
				((nonnull(1)));
...
void			ft_strdel(char **as) __attribute__
				((nonnull(1)));
...
void			ft_putchar(char c) __attribute__
				((noreturn));
...
void			ft_putendl(char const *s) __attribute__
				((noreturn));

void			ft_putnbr(int n) __attribute__
				((noreturn));

void			ft_putchar_fd(char c, int fd) __attribute__
				((noreturn));
...
void			ft_putnbr_fd(int n, int fd) __attribute__
				((noreturn));
